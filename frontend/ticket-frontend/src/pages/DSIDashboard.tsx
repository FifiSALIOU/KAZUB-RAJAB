              ...
              {selectedNotificationTicketDetails ? (
                <>
                  <div style={{
                    ...
                    <h3 style={{ margin: 0 }}>Détails du ticket {formatTicketNumber(selectedNotificationTicketDetails.number)}</h3>
                  </div>
      ...
      {viewTicketDetails && ticketDetails && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ marginBottom: "16px" }}>Détails du ticket {formatTicketNumber(ticketDetails.number)}</h3>
            <div style={{ marginBottom: "16px" }}>
              <strong>Titre :</strong>
              <p style={{ marginTop: "4px", padding: "8px", background: "#f8f9fa", borderRadius: "4px" }}>
                {ticketDetails.title}
            ...
            <div style={{ display: "flex", gap: "16px", marginBottom: "16px", flexWrap: "wrap" }}>
              <div>
                ...
                <span style={{
                  ...
                  fontSize: "12px",
                  fontWeight: "500",
                  background: ticketDetails.priority === "critique" ? "#fee2e2" : ticketDetails.priority === "haute" ? "rgba(245, 158, 11, 0.1)" : ticketDetails.priority === "moyenne" ? "rgba(13, 173, 219, 0.1)" : "#9e9e9e",
                  color: ticketDetails.priority === "critique" ? "#991b1b" : ticketDetails.priority === "haute" ? "#F59E0B" : "white"
                }}>
